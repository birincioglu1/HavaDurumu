...
class MainActivity : AppCompatActivity(), AdapterView.OnItemSelectedListener {
    ...
    private fun oankiSehriGetir(lat: String?, longt: String?) {
        ...
        val url = "https://api.openweathermap.org/data/2.5/weather?lat=" + lat + "&lon=" + longt + "&appid=d3b0c780f46ab7673a5031b17953d1ff&lang=tr&units=metric"
    ...
    fun verileriGetir(sehir: String) {
        ...
        val url = "https://api.openweathermap.org/data/2.5/weather?q=" + sehir + "&appid=d3b0c780f46ab7673a5031b17953d1ff&lang=tr&units=metric"
